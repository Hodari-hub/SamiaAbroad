...
var getNews=async()=>{
    ...
    try {
            ...
            response.data.articles.forEach(article => {
                if(article.urlToImage != null){
                    ...
                    download(article.urlToImage,img, function(){
                        let author=article.author,title=article.title, description=article.description,url=article.url, publishedAt=article.publishedAt, content=article.content;
        ...
        // .finally(function () { // always executed console.log("This is final code!"); });
    } 
